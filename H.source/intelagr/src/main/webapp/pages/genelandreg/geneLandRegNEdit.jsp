	...
	<div region="center" border="false" style="padding:5px;">
		...
		<fieldset class="fieldset_common_style">
			...
			<table class="table_common_style">
				<tr>
					...
					<s:select name="idType" id="idType" entityName="commondata" value="${idType }" codeKey="IDType" hasPleaseSelectOption="true"></s:select>	
			...
			<table class="table_common_style">
				<tr>
					...
					<td class="table_common_td_txt_style">
						...
						<s:select name="contractorType" id="contractorType" value="${contractorType }" entityName="commondata"  codeKey="ContractorType" hasPleaseSelectOption="true"></s:select>
						
					</td>
					<td class="table_common_td_label_style">承包方：</td>
					<td class="table_common_td_txt_style">
						<input class="easyui-textbox" name="tmp_contractorName" id="tmp_contractorName" readonly="readonly" value="${tmp_contractorName }"  style="width:150px;">
					</td>
					<td class="table_common_td_label_style">联系方式：</td>
					<td class="table_common_td_txt_style">
						<input class="easyui-textbox" name="tmp_contractorTel" id="tmp_contractorTel" value="${tmp_contractorTel }" style="width:150px;">
						<span class="span_common_mustinput_style">*</span>
					</td>
				</tr>
				<tr>
					...
					<td colspan="5" class="table_common_td_txt_style">
						<span style='display:none'>
							<select class="easyui-combobox" id="tmp_cityCode" name="tmp_cityCode">
								<option value="230184" selected>五常市</option>
							</select>
						</span>
						<select class="easyui-combobox" id="tmp_townCodeView" name="tmp_townCodeView" data-options="editable:false" style="width:150px;" disabled>
							<option value="${tmp_townCode }" selected>${tmp_townCodeView }</option>
						</select>
						<input type="hidden" id="tmp_townCode" name="tmp_townCode" value="${tmp_townCode }">
						...
						<select class="easyui-combobox" id="tmp_countryCodeView" name="tmp_countryCodeView" data-options='editable:false' style="width:150px;" disabled>
							<option value="${tmp_countryCode }" selected>${tmp_countryCodeView }</option>
						</select>
						<input type="hidden" id="tmp_countryCode" name="tmp_countryCode" value="${tmp_countryCode }">

						<input type="text" class="easyui-textbox" id="tmp_groupName" name="tmp_groupName" value="${tmp_groupName }" readonly="readonly" style="width:200px;">
					</td>
				</tr>
			</table>
		</fieldset>
		<fieldset class="fieldset_common_style">
			<table id="datas" height="120px;" width="100%" class="easyui-datagrid" striped="true" singleSelect="true">
				...
				<tbody>
				<c:forEach var="c" items="${editcontractList }" >
					<tr>
		...
		<fieldset class="fieldset_common_style">
			<table class="table_common_style">
				<tr>
					...
					<td class="table_common_td_txt_style">
						<input name="zmj" id="zmj" readonly="readonly" value="${zmj }" class="easyui-textbox" style="background-color:#B0B0B0;width:150px;">
					</td>
					<td class="table_common_td_label_style">已备案面积（亩）：</td>
					<td class="table_common_td_txt_style">
						<input name="ybamj" id="ybamj" readonly="readonly"  value="${yba }" class="easyui-textbox" style="background-color:#B0B0B0;width:150px;">
					</td>
				</tr>
				<tr>
					<td class="table_common_td_label_style">可备案面积（亩）：</td>
					<td class="table_common_td_txt_style">
						<input name="kbamj" id="kbamj" readonly="readonly" value="${kba }" class="easyui-textbox" style="background-color:#B0B0B0;width:150px;">
					</td>
					<td class="table_common_td_label_style"><strong>本次备案面积（亩）：</strong></td>
					<td class="table_common_td_txt_style">
						<input name="tmp_archiveAcreage" id="tmp_archiveAcreage" value="${tmp_archiveAcreage }" class="easyui-numberbox" precision="2" min="0.00" max="9999999.99"  style="width:150px;">
						<span class="span_common_mustinput_style">*</span>
					</td>
				</tr>
				<tr>   
					...
					<td class="table_common_td_txt_style">
						<input name="tmp_operatorName" id="tmp_operatorName" value="${tmp_operatorName }"  type="text" class="easyui-textbox" style="width:150px;">
						<span class="span_common_mustinput_style">*</span>
					</td>
					<td class="table_common_td_label_style"><strong>经办日期：</strong></td>
					<td class="table_common_td_txt_style editableFalse">
						<input class="easyui-datebox" name="tmp_operatorDateDate" id="tmp_operatorDateDate" value="${tmp_operatorDateDate }"
